...
function ircText(text) {
    ...
    for (var i = 0; i < content.length; i++) {
        if (i === 1 && text.toLowerCase().startsWith("/quit")) {
            result += " :";
        } else
        if (i === 2 && content.length !== 3 && !text.toLowerCase().startsWith("/mode") && !text.toLowerCase().startsWith("/quit") && !text.toLowerCase().startsWith("/kick")) {
            result += " :";
